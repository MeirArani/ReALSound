...
As referenced in previous chapters, \tech{OpenCV} has become the \emph{de facto} standard for computer vision implementations. The library comes bundled with hundreds of useful machine learning and computer vision algorithms that are deployable using only a handful of programming statements.
...
%%% CONCLUSION
\chapter{Conclusions}
In this thesis, we proposed \rs: the \rsfull.

...
\begin{figure}
    \begin{tabularx}{\linewidth}{|l|X|l|l|X|}
        \hline
        State & Description & \makecell{Transitions\\ (From)} & \makecell{Transitions \\(To)} & Example \\ \hline
        \state{Attract} 
        & Pre-game attract screen
        &\makecell{\state{Start} \trans \\ \state{Win} \trans}
        &\makecell{\trans \state{Pause}} 
        & \\ \hline
    
        \state{Pause} 
        & Short break between matches
        &\makecell{\state{Attract} \trans \\ \state{Goal} \trans}
        &\makecell{\trans \state{Match}}
        & \\ \hline
    
        \state{Match} 
        & A match of \emph{Pong} 
        &\makecell{\state{Pause} \trans}
        &\makecell{\trans \state{Goal}}
        & \\ \hline
    
        Goal 
        & Player scores a point 
        &\makecell{\state{Match} \trans}
        &\makecell{\trans \state{Pause} \\ \trans \state{Win}} 
        & \\ \hline
    
        Win 
        & Player wins game 
        & \makecell{\state{Goal} \trans}  
        & \makecell{\trans \state{Attract}}
        & \\ \hline
    \end{tabularx}
...
\begin{figure}
    \begin{tabularx}{\linewidth}{|l|X|}
        ...
        \texttt{position} & Position of entity on-screen \\ \hline
        \texttt{velocity} & Velocity of entity \\ \hline
        \texttt{velocity\_changed} & Flag set if entity changed directions this frame \\ \hline
        \texttt{active} & Flag set if entity is considered visible on-screen \\ \hline
    \end{tabularx}
...
\begin{figure}
    \begin{tabularx}{\linewidth}{|l|X|l|X|}
        \hline \\
        Name & Attributes & States & Visual \\ \hline
    \end{tabularx}
...
\todo{Detail dependency graph etc.}

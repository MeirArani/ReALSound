...
\subparagraph{Desinging \state{State} \state{Rules}}
...
\subparagraph{Designing \state{Entity} \state{Rules}}
Like the game itself, each entity has its own collections of \state{States} and \rules which govern it. These constructs define the entity's lifetime actions behaviors. 
